...
const VALID_COLLECTIONS = ['projects', 'documents', 'snippets', 'media', 'tasks', 'conversations', 'knowledge'];
const VERSIONED_COLLECTIONS = new Set(['documents', 'snippets', 'tasks', 'knowledge']);
